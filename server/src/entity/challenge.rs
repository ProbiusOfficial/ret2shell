...
pub async fn update_challenge(
    conn: &DatabaseConnection, id: i64, challenge: Model,
) -> Result<Model, DbErr> {
    let active_model = ActiveModel {
...
pub async fn get_challenge_page_by_game_and_user(
    conn: &DatabaseConnection, game: game::Model, user: user::Model, page: u64, per_page: u64,
    tag_id: Option<i64>,
...
pub async fn calc_challenge_score(
    conn: &DatabaseConnection, game: &game::Model, challenge: &Model,
) -> Result<i32, DbErr> {
...
async fn get_challenge_solves_in_game(
    conn: &DatabaseConnection, challenge: &Model, game: &game::Model,
) -> Result<u64, DbErr> {
...
pub async fn update_challenge_current_score(
    conn: &DatabaseConnection, challenge: &Model,
) -> Result<Model, DbErr> {
    let active_model = ActiveModel {
