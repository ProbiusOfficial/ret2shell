...
pub async fn get_user_page(
    db: &DatabaseConnection, page: u64, per_page: u64, order: Option<String>,
    filter: Option<String>, op_user: &Model,
...
pub async fn update_self_profile(
    db: &DatabaseConnection, id: i64, user: Model,
) -> Result<Model, DbErr> {
    let active_model: ActiveModel = ActiveModel {
        id: ActiveValue::Unchanged(id),
...
pub async fn update_user_password(
    db: &DatabaseConnection, id: i64, password: String,
) -> Result<Model, DbErr> {
